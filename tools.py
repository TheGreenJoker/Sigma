...
def effacer_terminal():
    ...
    print(r"_____/\\\\\\\\\\\____/\\\\\\\\\\\_____/\\\\\\\\\\\\__/\\\\____________/\\\\_____/\\\\\\\\\____             ____________  ")
    print(r" ___/\\\/////////\\\_\/////\\\///____/\\\//////////__\/\\\\\\________/\\\\\\___/\\\\\\\\\\\\\__           /\   ________) ")
    print(r"  __\//\\\______\///______\/\\\______/\\\_____________\/\\\//\\\____/\\\//\\\__/\\\/////////\\\_          \ \ \          ")
    print(r"   ___\////\\\_____________\/\\\_____\/\\\____/\\\\\\\_\/\\\\///\\\/\\\/_\/\\\_\/\\\_______\/\\\_          \ \ \         ")
    print(r"    ______\////\\\__________\/\\\_____\/\\\___\/////\\\_\/\\\__\///\\\/___\/\\\_\/\\\\\\\\\\\\\\\_          \ > >        ")
    print(r"     _________\////\\\_______\/\\\_____\/\\\_______\/\\\_\/\\\____\///_____\/\\\_\/\\\/////////\\\_          / /         ")
    print(r"      __/\\\______\//\\\______\/\\\_____\/\\\_______\/\\\_\/\\\_____________\/\\\_\/\\\_______\/\\\_        / /________  ")
    print(r"       _\///\\\\\\\\\\\/____/\\\\\\\\\\\_\//\\\\\\\\\\\\/__\/\\\_____________\/\\\_\/\\\_______\/\\\_      /___________) ")
    print(r"        ___\///////////_____\///////////___\////////////____\///______________\///__\///________\///__    /___________/  ", end='\n\n\n\n')
